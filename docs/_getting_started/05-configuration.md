---
title: "Configuration"
permalink: /getting_started/configuration/
...
Properly setting the locale is important for associating localized text found in the [**UI Text**]({{ "/getting_started/ui-text/" | relative_url }}) data file. An improper match will cause parts of the UI to disappear (eg. button labels, section headings, etc).
...
Consult the [JavaScript documentation]({{ site.baseurl }}{% link _getting_started/17-javascript.md %}) for more information on working with theme scripts.
{: .notice--info}
...
Breadcrumb start link text and separator character can both be changed in the [UI Text data file]({{ "/getting_started/ui-text/" | relative_url }}).
...
To add social media links not included with the theme or customize the author sidebar further, read the full [layout documentation]({{ "/getting_started/layouts/#author-profile" | relative_url }}).
...
You'll also need to include some Liquid and HTML to properly use the paginator, which you can find in the **Layouts** section under [Home Page]({{ "/getting_started/layouts/#home-page" | relative_url }}).
