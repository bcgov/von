...
permalink: /getting_started/posts/
...
Adding the above to `_config.yml` will assign the `single` layout and enable: *author profile*, *reading time*, *comments*, [*social sharing links*]({{ "/getting_started/layouts/#social-sharing-links" | relative_url }}), and *related posts*, for all posts.
