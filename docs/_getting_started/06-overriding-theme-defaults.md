...
permalink: /getting_started/overriding-theme-defaults/
...
For more information on customizing the theme's [stylesheets]({{ "/getting_started/stylesheets/" | relative_url }}) and [JavaScript]({{ "/getting_started/javascript/" | relative_url }}), see the appropriate pages.